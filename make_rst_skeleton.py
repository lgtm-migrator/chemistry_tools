...
print(chemistry_tools.name)
for subpackage in chemistry_tools.subpackages:
	print(f"{chemistry_tools.name}.{subpackage.name}")
	...
	for submodule in subpackage.submodules:
		submodule.make_rst([chemistry_tools.name, subpackage.name], subpackage_dir, extras=subpackage_dir.name)

for submodule in chemistry_tools.submodules:
	submodule.make_rst([chemistry_tools.name], docs_api_dir)
