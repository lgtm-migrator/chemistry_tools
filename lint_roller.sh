...
# fix these
declare errors="E301,E302,E303,E304,E305,E306,E502,E265,W291,W293,W391,E226,E225,E241,E231,"

# Be belligerent for these
declare belligerent="W292,"
...
if [ -z "$(git status --porcelain --untracked-files=no)" ] || [ "$1" == "-f" ]; then
  ...
  autopep8 --in-place --select "$warnings" -a --recursive tests/
  >&2 flake8 --select "$warnings" tests/


  echo "Running flake8"

    >&2 flake8 chemistry_tools/
