...
extras_require = {'pubchem': ['pandas>=1.0.1', 'beautifulsoup4>=4.7.0'], 'elements': ['domdf_python_tools>=0.2.6', 'memoized_property>=1.0.3'], 'formulae': ['mathematical>=0.1.7', 'pandas>=1.0.1', 'pyparsing>=2.2.0', 'tabulate>=0.8.3', 'cawdrey>=0.1.2', 'quantities>=0.12.4'], 'plotting': ['matplotlib>=3.0.0'], 'all': ['matplotlib>=3.0.0', 'pandas>=1.0.1', 'domdf_python_tools>=0.2.6', 'mathematical>=0.1.7', 'pyparsing>=2.2.0', 'cawdrey>=0.1.2', 'tabulate>=0.8.3', 'beautifulsoup4>=4.7.0', 'quantities>=0.12.4', 'memoized_property>=1.0.3']}
