...
extras_require = {'pubchem': ['cawdrey>=0.1.7', 'mathematical>=0.1.13', 'Pillow>=7.0.0', 'pyparsing>=2.2.0', 'tabulate>=0.8.3'], 'formulae': ['cawdrey>=0.1.7', 'mathematical>=0.1.13', 'pyparsing>=2.2.0', 'tabulate>=0.8.3'], 'plotting': ['matplotlib>=3.0.0'], 'toxnet': ['beautifulsoup4>=4.7.0'], 'all': ['Pillow>=7.0.0', 'beautifulsoup4>=4.7.0', 'cawdrey>=0.1.7', 'mathematical>=0.1.13', 'matplotlib>=3.0.0', 'pyparsing>=2.2.0', 'tabulate>=0.8.3']}
